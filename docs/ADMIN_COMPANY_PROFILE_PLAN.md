...
> 下一步为 3.5 独立后端进程与浏览器集中验收，代码恢复点 `0805b4a`。
...
| 3.4D4b | reviewer 原子领取、幂等裁决与断流恢复 | 已完成（开发版，浏览器验收留给 3.5） | `fc707fb`、`42a00fe`、`0805b4a` |
...
**下一次直接从 3.5 开始**：先核对 Git 检查点与本地服务状态，使用隔离测试库及测试账号启动
