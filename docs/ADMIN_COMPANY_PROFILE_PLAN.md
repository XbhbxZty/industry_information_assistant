...
> 3.4D1、3.4D2a1、3.4D2a2.1、3.4D2a2a、3.4D2a2b、3.4D2a3、3.4D2b 已完成；下一批为
> 3.4D3：最小密钥轮换。当前按开发/演示口径交付，不代表已可直接上线。
> 工程 Bad Case 见
...
D2a2b＋D2a3（已完成）→ D2b（已完成）→ D3 最小轮换 → D4a＋D4b → 3.5 集中联调。
...
**下次直接从 D3 开工**：沿用已实现的审计 keyring，先做 key 引用统计/退役预检与最小
